...
(function ($) {
  ...
  function loadResponse_elp(response, form) {
    ...
    var esSuccessEvent = {
      detail: { elp_response: message_class, msg: responseText },
      bubbles: true,
      cancelable: true,
    };
    ...
    $.ajax({
      ...
      success: function (response) {
        if (
          ...
          (response.status === "SUCCESS" || response.status === "ERRORBOT")
        ) {
        ...
        jQuery(window).trigger("elp_submit.send_response", [
          jQuery(form),
          response,
        ]);
...
function foreignHelper(hide) {
  ...
  var itemsToShowWhenHidden = [
    ".foreign_monthly_message",
    ".foreign_monthly_message .btn-donate",
  ];
  var init = () => {
    ...
    if (!hide) {
      ...
      $(".donate-payment-options[data-frequency=" + frequency + "]")
        .show()
        .addClass("selected");
    }
...
function foreignHelperInit(complete) {
  ...
  if (complete) {
    jQuery("body").on("click", "span.donate-steps-frequency", () => {
      setTimeout(() => {
        var frequency = jQuery("span.donate-steps-frequency.selected").data(
          "val"
        );
    ...
    jQuery("body").on("change", "#citizenship", (e) => {
      setTimeout(() => {
        ...
        foreignHelper(
          e.target.value != "Indian Citizen" && frequency != "one-time"
        );
      }, 100);
    });
    jQuery("body").on("click", "span.donate-steps-frequency", () => {
      setTimeout(() => {
        ...
        foreignHelper([isForeign, frequency != "one-time"].indexOf(false) < 0);
      }, 200);
    });
  }
}
jQuery(function () {
  ...
  $("select.causes").on("change", function (e) {
    ...
    $(
      ".donate-form-options[data-val=" + frequency + "] .donate-form-option"
    ).removeClass("selected");
    $(
      ".donate-form-options[data-val=" +
        frequency +
        "] .donate-form-option[data-cause]"
    ).hide();
    $(
      ".donate-form-options[data-val=" +
        frequency +
  ...
  $(
    ".donate-form-options .donate-form-option[data-cause]:not([data-cause=0])"
  ).hide();
});
...
(function ($, window, document, undefined) {
  ...
  Owl.prototype.onDragMove = function (event) {
    ...
    if (
      (this.drag.currentY > 1 || this.drag.currentY < -1) &&
      this.state.isSwiping === false
    ) {
...
function initHomeChildrenCircle() {
  ...
  $(document).on("click", function (event) {
    ...
    if (
      clickedClassName == "rel-wrapper" &&
      $(event.target)
        .closest(".approach-circle-wrapper")
        .hasClass("approach-circle-wrapper")
    ) {
  ...
  $(window).scroll(function () {
    ...
    $(".approach-circle-modal, .multiplier-adovcacy-circle-info").addClass(
      "hide-circle-modal"
    );
  });
  $(document).on("click", ".approach-circle-icon", function () {
    $(this)
      .closest(".approach-circle-item")
      .find(".approach-circle-modal")
      .removeClass("hide-circle-modal");
  });
  $(document).on("click", ".multiplier-advocacy-circle-title", function () {
    $(this)
      .closest(".multiplier-advocacy-circle")
      .find(".multiplier-adovcacy-circle-info")
      .removeClass("hide-circle-modal");
  });
}
  ...
  if ($(eleClass).hasClass("home-approach-icons-wrapper")) {
    ...
    if (animatingIconsWrapper == false) {
      ...
      var imgInterval = setInterval(function () {
        tempImgSrc = $(
          ".home-approach-icons-item:nth-child(" +
            imgIndex +
            ") img:first-child"
        ).attr("src");
        $(
        ...
        imgIndex++;
        if (imgIndex == 5) clearInterval(imgInterval);
      }, 550);
    }
  }
}
...
function playVideoModal(videoEle) {
  ...
  $("." + videoEle + " .yt-video")[0].contentWindow.postMessage(
        ...
        if (evt.toElement === null && evt.relatedTarget === null) {
          ...
          if (typeof pum_popups !== "undefined") {
            ...
            $.each(pum_popups, function (index, value) {
              popupSelector =
                value["triggers"][0]["settings"]["extra_selectors"];
    ...
    (pum_debug_mode =
      ...
      (pum_debug = {
        ...
        divider: function (e) {
          ...
          "string" == typeof e
            ? ((o = 62 - e.length),
              (t = { left: Math.floor(o / 2), right: Math.floor(o / 2) }).left +
                t.right ===
                o - 1 && t.right++,
...
(function (modules) {
  ...
  \***************************/
    ...
    function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(
          /*! @babel/runtime/helpers/toConsumableArray */
          "./node_modules/@babel/runtime/helpers/toConsumableArray.js"
        );
      var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default =
        __webpack_require__.n(
          _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__
        );
      var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(
          /*! @babel/runtime/helpers/slicedToArray */
          "./node_modules/@babel/runtime/helpers/slicedToArray.js"
        );
      var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default =
        __webpack_require__.n(
          _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__
        );
      var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(
          /*! @babel/runtime/helpers/defineProperty */
          "./node_modules/@babel/runtime/helpers/defineProperty.js"
        );
      var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default =
        __webpack_require__.n(
      ...
      var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default =
        __webpack_require__.n(
          _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3__
        );
      var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(
          /*! @babel/runtime/helpers/asyncToGenerator */
          "./node_modules/@babel/runtime/helpers/asyncToGenerator.js"
        );
      var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default =
        __webpack_require__.n(
      ...
      var wpcf7cf_getFieldsByOriginalName =
        function wpcf7cf_getFieldsByOriginalName(originalName) {
          return Object.values(wpcf7cf_dom).filter(function (inputField) {
            return (
              inputField.original_name === originalName ||
              inputField.original_name === originalName + "[]"
            );
          });
        };
      ...
      Wpcf7cfForm.prototype.updateGroups = function () {
        ...
        form.conditions = window.wpcf7cf.get_nested_conditions(
      ...
      Wpcf7cfRepeater.prototype.addSubs = function (subs_to_add) {
        ...
        if (index === null) {
          ...
          $html
            .hide()
            .insertBefore(
              jQuery("> .wpcf7cf_repeater_sub", $repeater).eq(index)
            )
            .animate(
              wpcf7cf_show_animation,
              params.wpcf7cf_settings.animation_intime
      ...
      window.wpcf7cf = {
        ...
        get_nested_conditions: function get_nested_conditions(
          conditions,
          $current_form
        ) {
          ...
          for (var i = 0; i < groups.length; i++) {
            ...
            var relevant_conditions = relevant_conditions.map(function (
              item,
              i
            ) {
              return {
        ...
        get_simplified_dom_model: function get_simplified_dom_model(
          ...
          var type =
            ...
            currentNode.classList.contains("wpcf7cf_repeater")
              ...
              ? "step"
              : currentNode.hasAttribute("name") && !currentNode.disabled
              ? "input"
              : false;
        ...
        should_group_be_shown: function should_group_be_shown(condition) {
          ...
          for (
            ...
            var inputField = wpcf7cf_getFieldByName(
              condition_and_rule.if_field
            );
  ...
  \******************************************************/
    ...
    function (module, exports, __webpack_require__) {
      (function (process, global) {
        ...
        this,
        __webpack_require__(
          /*! ./https://process/browser.js */
          "./node_modules/process/browser.js"
        ),
        __webpack_require__(
          /*! ./https://webpack/buildin/global.js */
...
function ivory_search_analytics(s, e, i) {
  try {
    ...
    if (!1 !== a)
      return void a("event", "Ivory Search - " + s, {
        event_label: e,
        event_category: i,
      });
    !1 !== t &&
...
!(function (s) {
  ...
  s(window).on("load", function () {
    ...
    s("#is-popup-wrapper").on("click", function (e) {
      s(e.target).closest("form").length ||
        s(
...
var donationpaymentgateway = $(".donate-payment-option.selected").attr(
  "data-val"
);
$(document).ready(function () {
  clearBirdfnSessions();
...
function clearMessage() {
  $("body").on("mouseup", ".donate-form-option", () =>
    $(".donation-amount-error").hide()
  );
  $("body").on("mouseup", ".donate-form-option", () =>
    $(".donation-amount-empty").hide()
  );
}
function stickyDonateForm() {
  ...
  var donateBannerOffset =
    $(".donate-bottom-img").offset().top - winHeight * 1.25;
  $(window).scroll(function () {
    ...
    if (scrollTop > donateBannerOffset) {
      $(".donate-form-block")
        .addClass("sticky-relative")
        .css("margin-top", donateBannerOffset + "px");
    } else {
      $(".donate-form-block")
        .removeClass("sticky-relative")
        .css("margin-top", "0px");
    }
  });
}
...
function selectDonationOption() {
  ...
  $(document).on("click", ".donate-form-option", function () {
    ...
    ele = $(this);
    ele
      .closest(".donate-form-options")
      .find(".donate-form-option")
      .removeClass("selected");
  ...
  $(document).on("click", ".donate-steps-frequency", function () {
    ...
    $(
      ".donate-steps-frequency, .donate-form-options, .donate-payment-options, .donate-form-field"
    ).removeClass("selected");
    $(".donate-steps-frequency:nth-child(" + frequencyIndex + ")").addClass(
      "selected"
    );
    $(".donate-form-options:nth-child(" + frequencyIndex + ")").addClass(
      "selected"
    );
    $(".donate-payment-options:nth-child(" + frequencyIndex + ")").addClass(
      "selected"
    );
    $(".donation-amount-error").hide();
    donateInfo = $(
      ".donate-form-options.selected .donate-form-option.selected .donate-form-info"
    ).html();
    $(".donate-form-details p").html(donateInfo);
  });
  donateInfo = $(
...
function showDonateTab(donateIndex) {
  ...
  $(".selected-donation-amount span")
    .html(Math.trunc(selectedDonationAmount[2]))
    .attr("donate-amount-val", selectedDonationAmount[0]);
  $(".selected-donation-frequency").html(
    selectedDonationAmount[1] + " Donation" + selectedDonationAmount[4]
  );
...
function goBackDonateTab() {
  ...
  if (donateIndex == 3) populateDonorForm();
  if (donateIndex > 1) {
    donateIndex--;
...
function changeDonateBullets(donateIndex) {
  ...
  $(".donate-form-bullets span:nth-child(" + donateIndex + ")").addClass(
    "selected"
  );
}
function getSelectedDonationAmount() {
  var selectedDonationAmount = [];
  var minimumDonationAmount = parseInt(
    $(".minimum-donation-amount").attr("data-val")
  );
  if (isBirdfnActive == true) {
    var birdfnAmount = parseInt(
      $(".donate-form-options.selected .donate-form-amount").attr(
        "data-amount-val"
      )
    );
    var additionalAmount = parseInt(
      $(".donate-form-options.selected .donate-form-field .form-field").val()
    );
    ...
    if (!$(".donate-form-field").hasClass("selected")) {
      selectedDonationAmount[0] = $(
        ".donate-form-options.selected .donate-form-option.selected .donate-form-amount"
      ).attr("data-amount-val");
      selectedDonationAmount[2] = $(
        ".donate-form-options.selected .donate-form-option.selected .donate-form-val"
      ).html();
    } else {
      if (
        $(
          ".donate-form-options.selected .donate-form-field .form-field-converted"
        ).attr("data-amount-val") != ""
      ) {
        selectedDonationAmount[0] = $(
          ".donate-form-options.selected .donate-form-field .form-field-converted"
        ...
        selectedDonationAmount[0] = $(
          ".donate-form-options.selected .donate-form-field .form-field"
        ).val();
      }
      selectedDonationAmount[2] = $(
        ".donate-form-options.selected .donate-form-field .form-field"
    ...
    selectedDonationAmount[5] =
      parseInt(selectedDonationAmount[2]) < minimumDonationAmount;
    if (
      ["quaterly", "half-yearly"].indexOf(
        $(".donate-steps-frequency.selected").attr("data-val")
      ) > -1
    ) {
      var years = $(
        ".donate-form-options.selected .donate-form-field .form-field.support_years"
      ).val();
      selectedDonationAmount[3] = years;
      selectedDonationAmount[4] = " for " + years + " years";
      selectedDonationAmount[0] =
        $(".donate-steps-frequency.selected").attr("data-val") == "quaterly"
          ? "" + parseInt(selectedDonationAmount[0]) / 4
          : "" + parseInt(selectedDonationAmount[0]) / 2;
  ...
  if ($(".donate-steps-frequency.selected").attr("data-val") == "monthly") {
    ...
    $(".donate-steps-frequency.selected").attr("data-val") == "half-yearly"
  ) {
    selectedDonationAmount[1] = "Half Yearly";
  } else selectedDonationAmount[1] = "One Time";
...
function detectUserDonationPage() {
  ...
  $("select#citizenship, select#location").change(function () {
    ...
    if (isForeignPage >= 0) {
      ...
      foreignURL =
        pathName.substring(0, slashIndex) +
        "/foreign-" +
        pathName.substring(slashIndex + 1);
      indiaDanaMojoURL = pathName.replace(/\/+$/, "") + "-danamojo/";
    }
    $(
      ".donor-confirmation-india, .donor-confirmation-indiaC, .donor-confirmation-indiaPC, .donor-confirmation-indiaOIC, .donor-confirmation-indiaPOIC, .donor-confirmation-foreign, .donor-confirmation-foreignC, .donor-confirmation-foreign1"
    ).removeClass("show");
    if (
      isForeignPage >= 0 &&
      LselectedVal == "Outside India" &&
      selectedVal == "Indian Citizen"
    ) {
...
function processDonateForm() {
  $(document)
    .off()
    .on("click", ".btn-donate", function (e) {
      $(".payment-method-error").removeClass("show");
      if (
        $(".donate-payment-options.selected .donate-payment-option").hasClass(
          "selected"
        ) &&
        endDateIsValid()
      ) {
...
function endDateIsValid() {
  if ($(".donate-payment-option.selected").attr("data-end-date") == "true") {
    var fieldVal = $(
      ".donate-payment-option.selected .recurring-end-date"
    ).val();
    if (fieldVal) {
...
function captureDonorDetails() {
  ...
  if (dataObject["location"] == "Within India") dataObject["country"] = "INDIA";
  else dataObject["country"] = $("#country").val();
...
function populateDonorForm() {
  ...
  $(".form-field").each(function () {
    ele = $(this);
    if (ele.val()) ele.addClass("form-field-has-val");
  });
}
function createDataObject() {
  dataObject["donateFrequency"] = $(".donate-steps-frequency.selected").attr(
    "data-val"
  );
  dataObject["donateYears"] = $(
    ".donate-form-options.selected .donate-form-field .form-field.support_years"
  ).val();
  dataObject["donateAmount"] = $("#donation-amount").val();
  dataObject["paymentMethod"] = $(".donate-payment-option.selected").attr(
    "data-val"
  );
...
function detectCurrency() {
  var minimumDonationAmountINR = parseInt(
    $(".minimum-donation-amount").attr("data-val")
  );
  ...
  $(document).on(
    ...
    function () {
      ...
      $(
        ".donate-form-options.selected .donate-form-field .form-field-converted"
      ).attr("data-amount-val", indianAmount);
    }
  );
}
