...
function showCareerOption() {
  ...
  $(document).on(
    "click",
    ".job-apply-btn-wrapper .btn-primary",
    function (event) {
      ele = $(this);
      roleName = ele
        .closest(".job-accordion")
        .find(".job-title-wrapper h4")
        .text();
  ...
  $(document).on(
    "click",
    ".bg-overlay, .careers-card-form .fa-close",
    function () {
