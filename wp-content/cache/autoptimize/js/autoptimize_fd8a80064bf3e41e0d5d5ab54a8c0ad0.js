...
function showVolunteerCard() {
  ...
  $(document).on(
    "click",
    ".volunteer-modal .fa-close, .bg-overlay, .volunteer-card-form .fa-close",
    function () {
  ...
  $(document).on("click", ".volunteer-modal .btn-primary", function () {
    ...
    $(".volunteer-modal, .volunteer-card-form").removeClass("show");
    formID = ele
      .closest(".volunteer-modal")
      .find(".volunteer-options-card-block")
      .attr("data-form-val");
    showModal("." + formID);
  });
}
