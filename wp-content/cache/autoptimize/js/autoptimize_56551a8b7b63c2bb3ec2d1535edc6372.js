              ...
              t.responsive &&
                n(window).on("resize", function () {
                  var e,
                    i,
                    r,
                    l = ((e = s), (i = t.direction), (r = o(e, i)), a(r, i)),
                    d = s.attr("data-style"),
                    c = n("#" + d + "_style")
                      .html()
                      .replace(
...
function initImpactOwlCarousel() {
  var stagePaddingVal = 0.15 * winWidth;
  if (isMobile) stagePaddingVal = 0.05 * winWidth;
...
function showFeet() {
  ...
  if (feetIndex <= feetCount / 2)
    $(
      ".multiplier-initial:not(.multiplier-result) img:nth-child(" +
        feetIndex +
        ")"
    ).addClass("show");
  else
    $(
      ".multiplier-result img:nth-child(" + (feetIndex - feetCount / 2) + ")"
    ).addClass("show");
  feetIndex++;
