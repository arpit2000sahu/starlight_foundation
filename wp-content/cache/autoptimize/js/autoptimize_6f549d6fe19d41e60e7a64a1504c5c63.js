...
function loadChildrenMap() {
  ...
  for (var i = 0; i < totalCount; i++) {
    if (i < totalCount * 0.4)
      childHTML +=
        "<img src='/wp-content/themes/cry/images/child-single-icon.png' class='child-show' alt='CRY Child' />";
    else
      childHTML +=
        "<img src='/wp-content/themes/cry/images/child-single-icon.png' alt='CRY Child' />";
  }
...
function showChildrenMap() {
  var childShowInterval = setInterval(function () {
    $(
      ".children-map-icon-wrapper img:nth-child(" + childrenCount + ")"
    ).addClass("show");
    childrenCount++;
